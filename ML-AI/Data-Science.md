# AI-ML devloper roadmap: Zero to Hero!!
...
<p align="center">
  <img width="660" height="300" src="https://user-images.githubusercontent.com/113570852/223106630-12ab6ddd-bda3-4325-a19e-8765a9d71b7d.jpg">
</p>


### 3. Data Scources for Analysis 
Once you're enough confident with your python programming and math fundamentals, now its time to dive deeper into the concepts of data analysis. There are various sources of data that can be used for analysis in Data Science. Here are some examples: **Public data repositories, Web scraping ,Personal data ,kaggle dataset.** You need to learn about Bitcoin, Ethereum and other crucial concepts such as public and private approaches, Decentralization, trustlessness, and etc. For this you can use various online courses and official documentation.

*[ Data mining](https://www.dummies.com/programming/big-data/data-science/data-mining-for-dummies-cheat-sheet/)

*[ Kaggle dataset ](https://www.kaggle.com/)

*[ Web scraping ](https://towardsdatascience.com/big-data-what-is-web-scraping-and-how-to-use-it-74e7e8b58fd6)
...
<p align="center">
  <img width="1060" height="300" src="https://user-images.githubusercontent.com/113570852/223109058-dbf4e2a0-7b6a-4736-a843-83a01b1f683e.png">
</p>

<br>
<br>

## 4. Exploratory Data Analysis /Data Munging/-Wrangling

Exploratory Data Analysis (EDA) and Data Munging/Wrangling are two important steps in the Data Science process that are used to prepare and understand the data before modeling.
Exploratory Data Analysis is the process of analyzing and summarizing the main characteristics of the data to gain insights and make decisions.Data Munging/Wrangling is the process of cleaning, transforming, and preparing the data for analysis.
<br>

<p align="center">
  <img width="1060" height="400" src="https://user-images.githubusercontent.com/113570852/223110858-b18e563b-1526-4b77-a5ad-e963a2da5d49.jpg">
</p>
...
data visualization
<p align="center">
  <img width="860" height="1000" src="https://user-images.githubusercontent.com/113570852/223118149-e6213f48-4312-4f23-bf6e-3fc6fb7c5a17.jpg">
</p>
...
Machine learning is a crucial component of data science. It is a field of artificial intelligence (AI) that enables computers to learn from data and improve their performance on a given task over time without being explicitly programmed. Machine learning algorithms are used to analyze data and discover patterns and insights that can be used to make better predictions or decisions.

<br>

<p align="center">
  <img width="860" height="500" src="https://user-images.githubusercontent.com/113570852/223119524-a68afd93-cc37-4a02-990c-9eb886567ee8.jpg">
</p>
